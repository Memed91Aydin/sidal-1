...
class ContactUs(models.Model):
    username=models.CharField(verbose_name='Users Full Name', max_length=50)
    user_email=models.EmailField(verbose_name='Users Email', max_length=250)
    ...
    phone = models.CharField(verbose_name='Users Phone',max_length=15)
...
class SocialMediaLinks(models.Model):
    ...
    icons = models.CharField(verbose_name='Icon from FontAwesome.com', max_length=150)
    color = models.CharField(verbose_name="Color Of Icon", max_length=250,default="#000")
